 ...
 */
#define SDL_TTF_VERSION(m_X)                          \
{                                                   \
    (m_X)->major = SDL_TTF_MAJOR_VERSION;             \
    (m_X)->minor = SDL_TTF_MINOR_VERSION;             \
    (m_X)->patch = SDL_TTF_PATCHLEVEL;                \
}
...
#define TTF_VERSION(m_X)      SDL_TTF_VERSION(m_X)
 ...
 */
#define SDL_TTF_VERSION_ATLEAST(m_X, m_Y, Z) \
    ((SDL_TTF_MAJOR_VERSION >= m_X) && \
     (SDL_TTF_MAJOR_VERSION > m_X || SDL_TTF_MINOR_VERSION >= m_Y) && \
     (SDL_TTF_MAJOR_VERSION > m_X || SDL_TTF_MINOR_VERSION > m_Y || SDL_TTF_PATCHLEVEL >= Z))
